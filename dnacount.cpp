//--------------------------------------------------------------------
//
//  Laboratory 3, In-lab Exercise 1                     dnacount.ccp
//
//  SOLUTION: Test program for the countBases function and the
//     countBases function.
//
//--------------------------------------------------------------------
...
// outputs the number of times that each base (A, C, G and T) occurs
// in the sequence.
...

{
    ...
    do
    {
        ...
        switch ( base )
        {
          ...
          case 'T' : case 't' :  tCount++;  break;
          case 'G' : case 'g' :  gCount++;  break;
          default :
